...
import { Grid, Button, Typography, TextField, DialogContent, Dialog, DialogTitle } from "@material-ui/core";
...
const Dialogs = (props) => {
  ...
  return (
    <>
      ...
      <Dialog onClose={props.handleStatusClose} aria-labelledby="dialog-title" open={props.stausOpen} width='md'
        PaperProps={{
          style: {
            width: '100%',
          },
          ...
          <div className={classes.center} >
            <div className={classes.drawerClose}>
              {props.view !== "undefined" && props.view !== "Offer Declined" ?
                ...
                <ArrowBackIcon className={classes.digClose} onClick={(e) => {
                  props.setView("undefined");
                }} />
                : ""}
            </div>
            <Typography variant="subtitle2" className={classes.digColor + " " + classes.digCenter}>  {props.shortList.statusCode === 301 ? "Has the profile been processed?" : props.shortList.statusCode === 3081 ? "Can you confirm if the candidate has indeed joined?" : "Send WhatsApp message"}  </Typography>
            <div className={classes.drawerClose} >
              <CloseIcon
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <ListItemText primary="Schedule Another Interview" />
                    </ListItem>
                    ...
                    >
                      ...
                      <ListItemText primary="Schedule Final Interview" />
                    </ListItem>
                    ...
                    : props.shortList.statusCode === 307 ?
                      ...
                      : props.shortList.statusCode === 3081 ?
                        ...
                        <>
                          ...
                          <Grid container direction="row" spacing={2} className={classes.center + " " + classes.p1020p}>
                            <Grid item xs={6}  > <Typography>Date of Joining</Typography> </Grid>
                            <Grid item xs={6}  >
                              <TextField
                                type="date"
            ...
            {props.shortList.statusCode === 301 ?
              ...
              : props.shortList.statusCode === 3081 ? <>
                ...
                <Button
                  ...
                  size="small"
                  color='secondary'
                  onClick={props.handleStatusClose} >No</Button>
              </>
                ...
                <>
                  ...
                  {props.shortList.statusCode === 304 ?
                    (props.view === "Schedule Another Interview" || props.view === "Schedule Final Interview" || props.view === "Send Document") ?
                      <>
                        ...
                        <Button
                          ...
                          color="primary"
                          size="small"
                          disabled={props.validation} type='submit' onClick={(e) => {

                            var message = "";
                            props.shortList.free === "NO" ? message = "" : message = messageRef.current.value;
                            ...
                            props.changeStatus(false, message, props.view, props.shortList.id);
                          }}
                        >
                          Save Only
                        </Button>
                        ...
                        <Button
                          ...
                          disabled={props.validation} type='submit' onClick={(e) => {
                            ...
                            props.changeStatus(true, message, props.view, props.shortList.id);
                          }}
                        >
                          Save & Send
                        </Button>
                        <Button variant="contained" color='secondary' size="small" onClick={props.handleStatusClose} >Close  </Button>
      ...
      <Dialog onClose={props.handleStatusNewClose} aria-labelledby="dialog-title" open={props.stausNewOpen} width='md'
        PaperProps={{
          style: {
            width: '100%',
          },
            ...
            {props.view === "Offer Declined" ? <>
              ...
              : props.view === "Ditch" ?
                ...
                <>
                  ...
                  <Button variant="contained" size="small" color='secondary' onClick={props.handleStatusNewClose} >Close</Button>
                </>
      ...
      >
        <DialogTitle className={classes.digTitle}>
          <div className={classes.center}>
            <Typography variant="subtitle2" className={classes.digColor + " " + classes.digCenter}> Are you certain you want to change this status? </Typography>
            <div className={classes.drawerClose} >
              <CloseIcon
      ...
      >
        <DialogTitle className={classes.digTitle}>
          <div className={classes.center}>
            <Typography variant="subtitle2" className={classes.digColor + " " + classes.digCenter}> {props.view === "Offer Declined" ? "Kindly provide the reason for the candidate's rejection of the job offer" : "Reason for candidate ditch"} </Typography>
            <div className={classes.drawerClose} >
              <CloseIcon
        ...
        <DialogContent className={classes.chatListBackGround}>
          ...
          <TextField
            ...
            classes={{ root: classes.customTextField }}
            InputProps={{ disableUnderline: true }}
            placeholder={props.view === "Offer Declined" ? "Kindly provide the reason for the candidate's rejection of the job offer" : "Enter Reason for Candidate Ditch"}
