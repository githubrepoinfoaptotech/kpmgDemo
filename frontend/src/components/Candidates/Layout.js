...
const Layout = (props) => {
  ...
  function OfferDeclineStatus(values) {
    ...
    return new Promise((resolve) => {
      axios({
        method: "post",
        url: props.OfferDeclineStatusUrl,
        data: {
          candidateId: shortList.id,
  ...
  function reverseConfirmation(id) {
    ...
    axios({
      method: "post",
      url: props.ReverseConfirmationUrl,
      data: {
        id: id,
      },
      headers: {
