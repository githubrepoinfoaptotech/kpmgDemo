...
import { Collapse,  Divider,  List,  ListItem,  ListItemIcon,  ListItemText,   ClickAwayListener } from "@material-ui/core";
...
onClick={(e) => { history.push(item.link);  setReport(false);  }}
disableRipple
>
  ...
  if (!children)
    return (
      ...
      <ListItem
        ...
        onClick={()=>{ sessionStorage.setItem('recruitmentId', ""); }}
        disableRipple
      >
        <ListItemIcon
          className={classnames(classes.linkIcon, {
  ...
  return (
   ...
   view===true? 
      ...
      <ListItem
        ...
        component={link && Link}
        onClick={()=>{
          toggleCollapse(); sessionStorage.setItem('recruitmentId', "");
        }}
        className={classes.link}
        to={link}
        disableRipple
