...
function FinalInterviewCompleted() {
  const candidateData=`${process.env.REACT_APP_SERVER}recruiter/getFICData`;
 ...
 const viewCandidateNotes = `${process.env.REACT_APP_SERVER}recruiter/viewCandidateNotes`;
  ...
  return (
    <div>
      <Layout
        title="Ongoing - Final Interview Completed"
...
export default FinalInterviewCompleted
